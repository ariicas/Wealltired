...
public class AnotherExample {
	...
	public static void main(String[] args) {
		 ...
		 * if sale is less than 10 commision will be 0 
		 * if sale is between 10 to 100-->10 comission is 10 percent
		 * if sale is between 101 to 500--> commission in 20%
		 * if sale is between 501 to 1000 --> commission is 30%
		 * if more than 1000---> comission is 50%
		 */
		Scanner scan;
		...
		System.out.print(" Your daily commission is "+commission);
